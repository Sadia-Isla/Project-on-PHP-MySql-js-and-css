	...
	<div class="main-header">
		<div class="container">
			<div class="row">
				...
				<div class="logo">
					<a href="index.php">	                          
						<img src="brandsimage/logo.png" height = "100" width = "100"  alt="Logo"></a>                              				
					</a>
				</div>		
				</div>
		...
		?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">USD.<?php echo ($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'>USD.<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
